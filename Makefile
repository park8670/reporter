...
SRC:=$(GOPATH)/src/github.com/park8670/reporter
...
.PHONY: build
build: 
	go install -v github.com/park8670/reporter/cmd/grafana-reporter

.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/park8670/reporter/cmd/grafana-reporter"
